...
set CLASSPATH=%APP_HOME%\lib\server-launcher-1.0.0.jar

@rem Execute GameServer
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS% -classpath "%CLASSPATH%" server.MainClass %CMD_LINE_ARGS%
